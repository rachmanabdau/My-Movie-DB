...
class FakeDataFactory {
    ...
    fun getInvalidApiKeyReposonse(): ResponseBody{
        return invalidApiResponse
            .toResponseBody("application/json;charset=utf-8".toMediaType())
    }

    fun getLogout401Error(): ResponseBody{
        val logoutError = """{
  "success": false,
  "status_code": 6,
  "status_message": "Invalid id: The pre-requisite id is invalid or not found."
    ...
    fun getAuthenticationError(): ResponseBody{
  ...
  "status_message": "Authentication failed: You do not have permissions to access the service."
    ...
    fun getDetailNotFoundResponse(): ResponseBody{
  ...
  "status_message": "The resource you requested could not be found."
    ...
    fun getInvalidUserShow(): ResponseBody{
        val userShowErrorResponse = """{
  "success": false,
  "status_code": 6,
  "status_message": "Invalid id: The pre-requisite id is invalid or not found."
}"""
        return userShowErrorResponse
            .toResponseBody("application/json;charset=utf-8".toMediaType())
    }

    fun getLoginSuccessResponse(): RequestTokenModel{
        return RequestTokenModel(
            "2016-08-26 17:04:39 UTC", "ff5c7eeb5a8870efe3cd7fc5c282cffd26800ecd", true
        )
    }

    fun getGuestSessionSuccessResponse(): GuestSessionModel{
        return GuestSessionModel(
            "2016-08-27 16:26:40 UT", "1ce82ec1223641636ad4a60b07de3581", true
        )
    }

    fun getInvalidAuthUserReposonse(): ResponseBody{
        return invalidUserAuthResponse
            .toResponseBody("application/json;charset=utf-8".toMediaType())
    }

    fun getNewSessionSuccessResponse(): NewSessionModel{
        return NewSessionModel(
            "1ce82ec1223641636ad4a60b07de3581", true
        )
    }

    fun getSearchMovieResult(page: Int = 1): SearchMovieResult{
        val moviResultconverter = moshi.adapter(SearchMovieResult::class.java)
        val emptyMovieResponse = moviResultconverter.fromJson(_emptyMovieResponse)
        val responseSuccess = moviResultconverter.fromJson(popularMovieResponse) as SearchMovieResult

        return if(page == 1){
            responseSuccess
        } else{
            emptyMovieResponse as SearchMovieResult
        }
    }

    fun getPopularMovieResponse(page: Int = 1): PopularMovie{
        val moviResultconverter = moshi.adapter(PopularMovie::class.java)
        val emptyMovieResponse = moviResultconverter.fromJson(_emptyMovieResponse)
        val responseSuccess = moviResultconverter.fromJson(popularMovieResponse) as PopularMovie

        return if(page == 1){
            responseSuccess
        } else{
            emptyMovieResponse as PopularMovie
        }
    }

    fun getNowPlayingMovieResponse(page: Int = 1): NowPlayingMovie{
        val moviResultconverter = moshi.adapter(NowPlayingMovie::class.java)
        val emptyMovieResponse = moviResultconverter.fromJson(_emptyMovieResponse)
        val responseSuccess = moviResultconverter.fromJson(nowPlayingMoviesResponse) as NowPlayingMovie

        return if(page == 1){
            responseSuccess
        } else{
            emptyMovieResponse as NowPlayingMovie
        }
    }

    fun getRecommendationMovie(): RecommendationMovie{
    ...
    fun getSimilarMovie(): SimilarMovie{
        val jsonConverter = moshi.adapter(SimilarMovie::class.java)
        val responseSuccess =
            jsonConverter.fromJson(similarMoviesResponse) as SimilarMovie
        return responseSuccess
    }

    fun getFavouriteMovie(page: Int = 1): FavouriteMovie{
        val jsonConverter = moshi.adapter(FavouriteMovie::class.java)
        val emptyMovieResponse = jsonConverter.fromJson(_emptyMovieResponse)
        val responseSuccess =
        ...
        return if(page == 1){
            responseSuccess
             ...
             emptyMovieResponse as FavouriteMovie
        }
    }

    fun getWatchListMovie(page: Int = 1): WatchListMovie{
        val jsonConverter = moshi.adapter(WatchListMovie::class.java)
        val emptyMovieResponse = jsonConverter.fromJson(watchListMovies)
        val responseSuccess =
            jsonConverter.fromJson(favouriteMovies) as WatchListMovie

        return if(page == 1){
            responseSuccess
        } else{
             emptyMovieResponse as WatchListMovie
        }
    }

    fun getDetailMovieResponse(): MovieDetail{
    ...
    fun getSearchTvResult(page: Int = 1): SearchTvResult{
        val moviResultconverter = moshi.adapter(SearchTvResult::class.java)
        val emptyMovieResponse = moviResultconverter.fromJson(_emptyTvShowResponse)
        val responseSuccess = moviResultconverter.fromJson(popularTvResponse) as SearchTvResult

        return if(page == 1){
            responseSuccess
        } else{
            emptyMovieResponse as SearchTvResult
        }
    }

    fun getPopularTvShow(page: Int = 1): PopularTvShow{
        val jsonConverter = moshi.adapter(PopularTvShow::class.java)
        val emptyTvShowResponse = jsonConverter.fromJson(_emptyTvShowResponse)
        val responseSuccess = jsonConverter.fromJson(popularTvResponse) as PopularTvShow

        return if(page == 1){
            responseSuccess
        } else{
            emptyTvShowResponse as PopularTvShow
        }
    }

    fun getOnairTvShow(page: Int = 1): OnAirTvShow{
        val jsonConverter = moshi.adapter(OnAirTvShow::class.java)
        val emptyTvShowResponse = jsonConverter.fromJson(_emptyTvShowResponse)
        val responseSuccess = jsonConverter.fromJson(popularTvResponse) as OnAirTvShow

        return if(page == 1){
            responseSuccess
        } else{
            emptyTvShowResponse as OnAirTvShow
        }
    }

    fun getRecommendationTv(): RecommendationTvShow{
    ...
    fun getSimilarTv(): SimilarTvShow{
        val jsonConverter = moshi.adapter(SimilarTvShow::class.java)
        val responseSuccess =
            jsonConverter.fromJson(similarTVShowsResponse) as SimilarTvShow
        return responseSuccess
    }

    fun getFavouriteTv(page: Int = 1): FavouriteTvShow{
        val jsonConverter = moshi.adapter(FavouriteTvShow::class.java)
        val emptyMovieResponse = jsonConverter.fromJson(_emptyTvShowResponse)
        val responseSuccess =
        ...
        return if(page == 1){
            ...
            emptyMovieResponse as FavouriteTvShow
        }
    }

    fun getWatchListTv(page: Int = 1): WatchListTvShow{
        ...
        return if(page == 1){
            ...
            emptyMovieResponse as WatchListTvShow
        }
    }

    fun getDetailTvResponse(): TVDetail{
    ...
    companion object {
        private const val invalidUserAuthResponse  = """{
  "status_message": "Invalid username and/or password: You did not provide a valid login.",
  "success": false,
  "status_code": 7
}"""

        private const val invalidApiResponse = """{
  "status_message": "Invalid API key: You must be granted a valid key.",
  "success": false,
  "status_code": 7
}"""

        private const val detailMovieResponse = """{
  "adult": false,
  ...
  "vote_count": 157
        ...
        private const val _emptyMovieResponse = """{
  "page": 2,
  "total_results": 0,
  "total_pages": 0,
  "results": []
        ...
        private const val popularMovieResponse = """{
  "page": 1,
  "total_results": 40,
  "total_pages": 2,
  "results": [
    ...
    },
    {
      ...
      "release_date": "2020-09-10"
        ...
        private const val nowPlayingMoviesResponse = """{
  "results": [
    {
      "popularity": 2367.963,
      "vote_count": 28,
  ...
  "total_pages": 75
        ...
        private const val recommendationMoviesResponse = """{
  "page": 1,
  "results": [
    {
      "id": 472815,
  ...
  "total_results": 40
        ...
        private const val similarMoviesResponse = """{
  "page": 1,
  "results": [
    {
      "id": 744,
  ...
  "total_results": 100
        ...
        private const val favouriteMovies = """{
  "page": 1,
  "results": [
    {
      "id": 617505,
  ...
  "total_results": 18
        ...
        private const val watchListMovies = """{
  "page": 1,
  "results": [
    {
      "id": 671145,
  ...
  "total_results": 17
        ...
        private const val detailTVShowResponse = """{
  ...
  "vote_count": 2623
        ...
        private const val _emptyTvShowResponse = """{
  "page": 2,
  "total_results": 0,
  "total_pages": 0,
  "results": []
        ...
        private const val popularTvResponse = """{
  "page": 1,
  "total_results": 10000,
  "total_pages": 500,
  "results": [
    ...
    },
    {
      ...
      "poster_path": "/sWgBv7LV2PRoQgkxwlibdGXKz1S.jpg"
        ...
        private const val onAirTVResponse = """{
  "page": 1,
  "total_results": 552,
  "total_pages": 28,
  "results": [
    ...
    },
    {
      ...
      "poster_path": "/c3EurMWJu1hXKUeJVvLIoJaN26j.jpg"
        ...
        private const val recommendationTVShowsResponse = """{
  "page": 1,
  "results": [
    {
  ...
  "total_results": 40
        ...
        private const val similarTVShowsResponse = """{
  "page": 1,
  "results": [
    {
      "original_name": "The Walking Dead",
  ...
  "total_results": 958
        ...
        private const val favouriteTVShows = """{
  "page": 1,
  "results": [
    {
  ...
  "total_results": 12
        ...
        private const val accountDetailResponse = """{
  "avatar": {
    "gravatar": {
